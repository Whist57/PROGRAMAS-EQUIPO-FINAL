...
int main(void) {
    ...
    printf("\nIngresa el numero de actividades: ");
    scanf("%d", &n);
    ...
    for (int i = 0; i < n; i++) {
        ...
        if (strcmp(fecha, actividades[i].fecha) == 0) {
            printf("\nActividad %d: Actividad valida.\n", i + 1);
            fprintf(archivo, "%s %s: Actividad valida.\n", actividades[i].fecha, actividades[i].concepto);
        }

        else {
            printf("\nActividad %d: Actividad no valida.\n", i + 1);
            fprintf(archivo, "%s %s: Actividad no valida.\n", actividades[i].fecha, actividades[i].concepto);
        }
    }
